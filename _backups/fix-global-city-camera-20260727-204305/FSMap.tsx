...
function RecipientCameraController({
  latitude,
  longitude,
  zoom = 11,
}: {
  ...
  useEffect(() => {
    ...
    /*
     * defaultCenter påverkar bara kartans första montering.
     * När användaren gör en ny sökning måste den befintliga
     * Google-kartan flyttas aktivt.
     */
    map.panTo({
      lat: nextLatitude,
      lng: nextLongitude,
