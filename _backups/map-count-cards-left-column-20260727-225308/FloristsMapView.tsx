        ...
        <div className="rounded-[34px] bg-white p-5 shadow-sm ring-1 ring-stone-200/70 md:p-7">
          ...
          <div className="mt-6 grid gap-5 lg:grid-cols-[360px_1fr]">
            ...
            <div className="relative aspect-square min-h-[620px] overflow-hidden rounded-[32px] bg-white ring-1 ring-stone-200">
              <div className="pointer-events-none absolute left-4 top-4 z-20 max-w-[calc(100%-2rem)] rounded-2xl bg-white/95 px-4 py-3 shadow-lg ring-1 ring-stone-200 backdrop-blur-sm">
                <p className="text-sm font-black text-stone-950">
                  {connectedFloristCount}{" "}
                  {connectedFloristCount === 1
                    ? "florist är ansluten"
                    : "florister är anslutna"}{" "}
                  till FloristSocial
                </p>

                <p className="mt-1 text-xs font-bold text-stone-600">
                  Totalt {totalVisibleMapCount}{" "}
