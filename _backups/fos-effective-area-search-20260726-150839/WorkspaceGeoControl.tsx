...
export default function WorkspaceGeoControl({
  ...
  async function focusSearchOnMap(
    ...
    /*
     * GEO Control kräver en tydlig geografisk
     * kombination. Det förhindrar att samma
     * stadsnamn hamnar i fel land.
     */
    ...
    /*
     * Florist-/områdesfältet används som filter.
     * Själva kartpositionen bestäms av stad + land.
     */
    const query =
      cityValue;
    ...
    try {
      ...
      setMapSearchStatus(
        errorMessage.includes(
          ...
          ? `Kunde inte hitta ${cityValue} i ${countryValue}. Kontrollera att rätt land och stad är angivna.`
          : errorMessage,
      );
    } finally {
