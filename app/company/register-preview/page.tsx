...
const paymentMethods = [
  ...
  "Swish",
  "Banköverföring",
  "Faktura efter godkänd kreditkontroll",
];
const swedishCities = [
  "Stockholm",
  "Göteborg",
...
export default function CompanyRegistrationAndOrderPage() {
  ...
  function handleRegistrationSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    setSubmitMessage(
      `✅ Företagsregistrering skapad för kundnummer ${customerNumber}. Nästa steg är att koppla formuläret till Supabase/API.`,
    );
  }
  ...
  function handleOrderSubmit(event: React.FormEvent<HTMLFormElement>) {
    event.preventDefault();
    setSubmitMessage(
      `✅ Företagsorder skapad för kundnummer ${customerNumber}. Beställning: ${selectedOrderType}, ${displayPrice}, antal ${quantity}.`,
    );
  }
        ...
        <div className="relative mx-auto max-w-7xl space-y-8">
          <header className="max-w-4xl">
            ...
            <p className="mt-5 text-lg leading-8 text-stone-600">
              För att kunna genomföra företagsbeställningar som ska betalas med
              faktura, fyll i formuläret nedan. Vi bekräftar beställningen inom
              kort. Ni kan även ringa oss till telefonnummer{" "}
              <strong>08-673 73 48</strong> för mer information och/eller för
              beställningar samt vid önskad snabbleverans.
            </p>
            <p className="mt-3 text-base leading-7 text-stone-600">
              Fraktkostnad beräknas utifrån avståndet mellan levererande
              florist/blomsterbutik och leveransadressen.
            </p>
          </header>
              ...
              <form onSubmit={handleRegistrationSubmit} className="space-y-6">
                <Card>
                  <SectionHeader
                    ...
                    description="Alla fält med röd stjärna är obligatoriska. Datum, tid, ort och kundnummer genereras på formuläret."
                  />
                  ...
                  <div className="mt-6 grid gap-4 md:grid-cols-2">
                    ...
                    <Field
                      ...
                      name="contactPhone"
                      label="Telefonnummer"
                      placeholder="Till ex.: Telefonnummer kontaktperson"
                      type="tel"
                      icon={<Phone size={18} />}
                    />
                    <PasswordFields
              ...
              <form onSubmit={handleOrderSubmit} className="space-y-6">
                <Card>
                  <SectionHeader
                    ...
                    title="Företagsorder"
                    description="Företag kan beställa både avhämtning och leverans. Appen genererar företagets namn, kundnummer, datum, tid och ort på företagsordern."
                  />
                  ...
                  <div className="mt-6 grid gap-4 md:grid-cols-2">
                    ...
                    <Field
                      ...
                      name="reference"
                      label="Er referens"
                      placeholder="Till ex.: Projektnummer, kostnadsställe, osv."
                    />
                    <Field
                      required
                      name="orderEmail"
                  ...
                  <div className="mt-6 grid gap-4 md:grid-cols-2">
                    ...
                    <Textarea
                      ...
                      label="Special önskemål"
                      placeholder="Till ex.: Färgglad, pollenfri ..."
                    />
                  </div>
                  ...
                  <div className="mt-8 grid gap-4 md:grid-cols-2">
                    ...
                    <div className="rounded-2xl bg-stone-50 p-4 text-sm leading-6 text-stone-600">
                      <strong>Betalkort med Stripe visas först.</strong> Faktura
                      kräver manuell kreditkontroll innan företaget kan handla
                      mot faktura.
                    </div>
                  </div>
                  ...
                  <div className="mt-8">
                    <h3 className="mb-3 font-semibold">
                      Extra produkter som beställaren kan klicka och köpa
                    </h3>
            ...
            <aside className="lg:sticky lg:top-8 lg:h-fit">
              <div className="rounded-3xl bg-white p-6 shadow-xl">
                ...
                <div className="mt-6 rounded-2xl bg-stone-50 p-4 text-sm leading-6 text-stone-600">
                  <strong>Obs:</strong> Fakturaflödet, kundnummer i databas,
                  orderbekräftelse och fraktberäkning kopplas i nästa steg till
                  Supabase/API.
                </div>
              </div>
            </aside>
