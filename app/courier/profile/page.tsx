...
export default function CourierProfilePage() {
  return (
    <BusinessProfile
      roleLabel="Budfirma"
      title="Budfirma profil"
      description="Intern profilsida för partnerbeställningar, ersättning, faktura och kommunikation med florister."
      icon={<Building2 size={36} />}
      cards={[
        ["Beställningar", "Budfirmans beställningar via FloristSocial.", <ShoppingBag key="o" />],
        ["Faktura", "Faktura, partnerersättning och återbetalning.", <CreditCard key="f" />],
        ["Redovisning", "10% partnerersättning minus betalningsavgift i proportion.", <ReceiptText key="r" />],
        ["Kontaktpersoner", "Kontaktpersoner, förare och interna referenser.", <User key="u" />],
      ]}
    />
  );
}
...
<CalendarEngine role="courier" floristId="internal-profile" />
        </div>
          ...
          <div className="space-y-6">
            ...
            <Panel title="Orderöversikt" icon={<ShoppingBag size={22} />}>
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5 text-sm font-semibold text-slate-600">
                Här visas budfirmans beställningar, kunder, ersättningar och kvitton.
              </div>
            </Panel>
          </div>
