...
function visualFor(
  ...
  const hasColor = (color: string) => selectedColors.includes(color);

  if (group === "Bukett" && style === "Romantisk" && hasColor("Rosa")) {
    return "/design-preview/buketter/bukett-romantisk-rosa-1000.jpg";
  }

  if (group === "Bukett" && style === "Floristens val") {
    return "/design-preview/buketter/bukett-floristens-val-pastell-750.jpg";
  }

  if (group === "Bukett" && style === "Modern") {
    return "/design-preview/buketter/bukett-modern-orange-rosa.jpg";
  }

  if (group === "Rosor") {
    return "/design-preview/rosor/rosor-roda-premium.jpg";
  }

  if (group === "Begravning") {
    return "/design-preview/begravning/krans-sorg-natur-3200.jpg";
  }

  if (group === "Event") {
    return "/design-preview/event/scendekoration-fargrik-6000.jpg";
  }
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 rounded-[2rem] bg-white/80 p-5 shadow-sm">
          <p className="text-sm font-medium text-pink-700">
            FloristSocial Beställningsstudio V4.4
          </p>
                      ...
                      <div className="mt-4 overflow-hidden rounded-[1.5rem] border border-white/80 bg-white/70 shadow-inner">
                        <img
                          src={
                            ...
                            visualFor(group, product, style, selectedColors)
                          }
