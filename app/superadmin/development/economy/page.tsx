  ...
  return (
    <main className="min-h-screen bg-[#f7f2ea] px-4 py-8 text-slate-950 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl rounded-[2.25rem] bg-white p-8 shadow-xl shadow-slate-200/70">
        ...
        <h1 className="mt-4 text-4xl font-black tracking-tight">Economy</h1>

        <p className="mt-4 text-base font-semibold leading-7 text-slate-600">
          Test- och statussida för Economy. Här kopplas senare riktig Engine Health, events, state och tester.
        </p>
      </div>
    </main>
  );
