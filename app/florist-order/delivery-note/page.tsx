...
const delivery = {
  ...
  instructions:
    "Ring mottagaren om porten är låst. Kan lämnas till granne vid behov.",
};
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 13, fontWeight: 850, color: "#e60073" }}>
                För budfirma och leveransspårning
              </div>
            </div>
          </div>
      ...
      <div style={{ width: 1180, margin: "0 auto", padding: "30px 0 70px" }}>
        ...
        >
          ...
          >
            <div>
              ...
              >
                Leveranssedeln genereras när Florist-2 vill skicka ut buketten
                med budfirma. Fyra QR-koder används för upphämtning, på väg,
                levererat och avvikelse.
              </p>
            </div>
        ...
        >
          ...
          <Card title="Mottagare" icon={<UserRound size={23} />}>
            ...
            <DataRow
              label="Port / våning / lgh"
              value={`Portkod ${delivery.portCode} · Våning ${delivery.floor} · Lgh ${delivery.apartment}`}
            />
          </Card>
        </section>
        ...
        >
          ...
          >
            <div>
              <h2 style={{ margin: 0, fontSize: 23, fontWeight: 950 }}>
                Fyra exakta QR-koder
              </h2>
              <p style={{ margin: "6px 0 0", fontSize: 14, color: "#78716c" }}>
                Varje QR-kod uppdaterar orderns status i FloristSocial och
                synkas till båda floristernas orderhistorik och kalender.
              </p>
            </div>
            <div
              style={{
...
function QrCard({
  ...
  return (
    ...
    >
      ...
      <h3 style={{ margin: "14px 0 0", fontSize: 15, fontWeight: 950 }}>
        {title}
      </h3>
      <p
        style={{
