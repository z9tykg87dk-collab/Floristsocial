...
mkdir -p app/workspace/event-store
mkdir -p app/workspace/event-store/test

cat > app/workspace/event-store/page.tsx <<'TSX'
...
cat > app/workspace/event-store/test/page.tsx <<'TSX'
import Link from "next/link";
